function navigation() {
    ...
    "navigation" === t.className ? t.className += "responsive" : t.className = "navigation"
}(function() {
...
}).call(this), (new WOW).init(), $(function() {
...
var firstWrd = document.getElementById("wordRotator").innerHTML = "<h1>Creators</h1>",
    words = ["<h1>Developers</h1>", "<h1>Imaginators</h1>", "<h1>Dreamers</h1>", "<h1>Creators</h1>"],
    getDiv, count = 0;
setInterval(function() {
    4 > count && (getDiv = document.getElementById("wordRotator").innerHTML = words[count], count++, 4 == count && (count = 0))
}, 6e3),
$(document).ready(function() {
    $(window).scroll(function() {
        var t = $(window).scrollTop();
        t > 250 ? ($(".navbar-fixed-top").addClass("navbar-custom"), $(".navbar-fixed-top").removeClass("navbar-transparent")) : 250 > t ? ($(".navbar-fixed-top").removeClass("navbar-custom"), $(".navbar-fixed-top").addClass("navbar-transparent")) : ($(".navbar-fixed-top").addClass("navbar-transparent"), $(".navbar-fixed-top").removeClass("navbar-custom"))
    })
});
